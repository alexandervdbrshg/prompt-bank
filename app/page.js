          ...
          <div className="flex gap-3">
            <div className="relative">
              ...
              <select
                ...
                className="pl-12 pr-8 py-3 bg-white/5 border border-white/10 rounded-none text-white focus:outline-none focus:border-white/30 appearance-none transition"
              >
            ...
            <button
              ...
              className="px-4 py-3 border border-white/10 rounded-none hover:bg-white/5 transition flex items-center gap-2"
            >
              Manage Tools
            </button>
            ...
            <button
              ...
              className="px-6 py-3 bg-white text-black rounded-none hover:bg-white/90 transition flex items-center gap-2 font-medium"
            >
              <Plus size={20} />
              Add Prompt
            </button>
            ...
            <div className="bg-zinc-900 border border-white/10 max-w-md w-full">
              <div className="p-8">
                <div className="flex justify-between items-center mb-8 pb-6 border-b border-white/10">
                  <h2 className="text-3xl font-light">Manage Tools</h2>
                  <button onClick={() => setShowToolManager(false)} className="text-white/60 hover:text-white transition">
                    <X size={24} />
                  </button>
                </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        onClick={addTool}
                        className="px-6 py-3 bg-white text-black rounded-none hover:bg-white/90 transition font-medium"
                      >
                        Add
                      </button>
                    </div>
                      ...
                      {tools.length === 0 ? (
                        ...
                        tools.map((tool, index) => (
                          <div key={index} className="flex items-center justify-between p-3 bg-white/5 border border-white/10">
                            <span className="text-white/90 font-light">{tool}</span>
                            <button
        ...
        {deleteConfirm && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-zinc-900 border border-white/10 max-w-md w-full p-8">
              <h2 className="text-2xl font-light mb-4">Delete Prompt?</h2>
              <p className="text-white/60 mb-8 font-light">Are you sure you want to delete this prompt? This action cannot be undone.</p>
              <div className="flex gap-3">
                <button
        ...
        {showForm && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-start justify-center p-4 z-50 overflow-y-auto pt-8 pb-8">
            <div className="bg-zinc-900 border border-white/10 max-w-2xl w-full">
              <div className="p-8">
                <div className="flex justify-between items-center mb-8 pb-6 border-b border-white/10">
                  <h2 className="text-3xl font-light">New Prompt</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="border-2 border-dashed border-white/10 p-8 text-center hover:border-white/30 transition">
                      <input
                        type="file"
                        multiple
                        accept="image/*,video/*"
        ...
        {filteredPrompts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            {filteredPrompts.map(prompt => (
              <div key={prompt.id} className="bg-white/5 border border-white/10 p-6 hover:border-white/20 transition group relative">
                <button
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                ...
                <div className="mb-4">
                  ...
                  <p className="text-white/90 text-sm leading-relaxed line-clamp-3 font-light">
                    {prompt.prompt}
                  </p>
                </div>
                ...
                <div className="mb-4">
                  ...
                  {prompt.result_text && (
                    <p className="text-white/80 text-sm leading-relaxed line-clamp-3 mb-3 font-light">
                      {prompt.result_text}
                    </p>
                  )}
