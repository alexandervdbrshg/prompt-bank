...
export default function PromptBank({ onNavigate, onLogout }) {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 md:mb-12 border-b border-custom-white/10 pb-6 md:pb-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-kurdis tracking-wider mb-2 md:mb-3">PROMPT LIBRARY</h1>
              <p className="text-custom-white/60 text-base md:text-lg font-light">SporthouseGroup's curated AI prompts</p>
            </div>
